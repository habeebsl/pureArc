...
-----
  # from backend/
  python scripts/debug_rim.py                    # uses test_shot4.mp4, 5 frames
  python scripts/debug_rim.py test_shot2.mp4 8  # custom video, 8 frames
"""
...
from detectors.rim import RimDetector, _HSV_LOW, _HSV_HIGH

_CUSTOM_WEIGHTS = os.path.join(_BACKEND_DIR, "runs", "rim_detector", "weights", "best.pt")
